...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB") or "rationalanswer",
...
TELEGRAM_BOT_URL = os.getenv("TELEGRAM_BOT_URL") or "https://t.me/RationalAnswer_club_bot"
